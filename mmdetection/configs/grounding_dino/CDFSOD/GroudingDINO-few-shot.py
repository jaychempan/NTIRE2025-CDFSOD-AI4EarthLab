...
model = dict(
    ...
    #         type='HungarianAssigner',
    #         match_costs=[
    #             dict(type='BinaryFocalLossCost', weight=3.0),  # 增强分类权重
    #             dict(type='BBoxL1Cost', weight=2.5, box_format='xywh'),  # 降低框回归影响
    #             dict(type='IoUCost', iou_mode='giou', weight=1.5)  # 适当降低IoU权重
    #         ])),
    ...
    #         type='HungarianAssigner',
    #         match_costs=[
    #             dict(type='BinaryFocalLossCost', weight=2.5),  # 适度增强分类权重
    #             dict(type='BBoxL1Cost', weight=4.0, box_format='xywh'),  # 适度增加框回归权重
    #             dict(type='IoUCost', iou_mode='giou', weight=2.0)  # 维持IoU权重
    #         ])),
    ...
    #         type='HungarianAssigner',
    #         match_costs=[
    #             dict(type='BinaryFocalLossCost', weight=2.0),  # 维持原始分类权重
    #             dict(type='BBoxL1Cost', weight=5.0, box_format='xywh'),  # 保持高权重
    #             dict(type='IoUCost', iou_mode='giou', weight=3.0)  # 增强 IoU 影响
    #         ])),
...
# # 然后添加一个钩子，控制前几个 epoch 不验证
# custom_hooks = [
#     dict(
#         type='EarlyStopValHook',
#         val_begin=5  # 例如从第5个 epoch 开始验证
#     )
# ]
